...
REPO_NAME = "prithvi-eo-feature-extraction-pipeline"
NOTEBOOK_NAME = "prithvi_eo_feature_extraction_colab.ipynb"
WORKSHOP_NOTEBOOK_NAME = "DIMER_AI_for_Earth_Observation_and_Climate_Applications_Workshop.ipynb"
EXPECTED_PROFILE = "E2E"
EXPECTED_MODEL_ID = "ibm-nasa-geospatial/Prithvi-EO-2.0-300M"
...
EXPECTED_OUTPUTS = (
    ...
    "outputs/prithvi_eo_feature_extraction_predictions.json",
    "outputs/prithvi_eo_feature_extraction_adapter",
    "outputs/prithvi_eo_feature_extraction_result.json",
)
CODE_MARKERS = (
...
MARKDOWN_MARKERS = (
    ...
    "A foundation model has no task head",
    "linear probe",
    "mean-fill baseline",
    "majority baseline",
    "no `extractall`",
    "Split by site or tile",
    "sample-sanity",
    "CC BY 4.0",
)
